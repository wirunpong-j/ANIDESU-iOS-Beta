...
class DiscoverAnimeMenuVC: TabmanViewController, PageboyViewControllerDataSource {
    ...
    private func setUpView() {
        // configure the bar
        self.bar.items = [Item(title: SeasonType.WINTER.rawValue),
                          Item(title: SeasonType.SPRING.rawValue),
                          Item(title: SeasonType.FALL.rawValue),
                          Item(title: SeasonType.SUMMER.rawValue)]
